    ...
    render() {
        return (
            <ul className='PresentationalList'>
                ...
                <li className="li" style={{opacity: 0.5}}>
                <CardPresentacion handlerPage={this.props.handlerPage} pagina='' title='Publicar Propiedad' description='Publica tu propiedad' imagen='https://www.hogares.cl/wp-content/uploads/2018/06/SLA_3734.jpg'></CardPresentacion>
                </li>
                <li className="li" style={{opacity: 0.5}}>
