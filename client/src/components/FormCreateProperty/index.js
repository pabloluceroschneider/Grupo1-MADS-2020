    ...
    <div className="form-property">
	  ...
	  <Form.Field>
          ...
          <input
            ...
            placeholder="Título"
            onChange={(event) =>
              setFields({ ...fields, titulo: event.target.value })
            }
          />
        </Form.Field>
        <Form.Field>
          ...
          <input
            ...
            onChange={(event) =>
              setFields({ ...fields, ubicacion: event.target.value })
            }
          />
        </Form.Field>
        ...
        <Form.Group widths="equal">
          <Form.Input
            ...
            placeholder="Latitud"
            onChange={(event) =>
              setFields({ ...fields, lat: event.target.value })
            }
          />
          <Form.Input
            fluid
            ...
            onChange={(event) =>
              setFields({ ...fields, longitud: event.target.value })
            }
          />
        </Form.Group>
        ...
        <Form.Group widths="equal">
          ...
          <Form.Input
            ...
            placeholder="Precio"
            onChange={(event) =>
              setFields({ ...fields, precios: parseFloat(event.target.value) })
            }
          />
        </Form.Group>
        ...
        <Form.Field>
          <input
            type="file"
            multiple
            onChange={(e) => setFields({ ...fields, images: e.target.files })}
          />
        </Form.Field>
